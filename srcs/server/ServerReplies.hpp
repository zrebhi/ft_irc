...
/*   Updated: 2023/10/14 00:30:14 by zrebhi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* 353 */ #define RPL_WHOREPLY(nick, channelName, userList) ":IRC 353 " + nick + " = " + channelName + " :" + userList
...
/* 433 */ #define ERR_NICKNAMEINUSE(nickname) ":IRC 433 * " + nickname + " :Nickname is already in use"
